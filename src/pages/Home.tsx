      ...
      <section className="relative min-h-[100vh] flex items-center pt-20 overflow-hidden bg-background">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 grid lg:grid-cols-2 gap-12 lg:gap-8 items-center w-full">
          <div className="max-w-2xl pt-10">
            ...
            >
              <a href="https://www.youtube.com/channel/UCsFk-vk4JYXWzYT0f3htKVQ" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full flex items-center justify-center transition-all text-primary hover:bg-primary/5 hover:-translate-y-1">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33A2.78 2.78 0 0 0 3.4 19c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.25 29 29 0 0 0-.46-5.33z"></path><polygon points="9.75 15.02 15.5 11.75 9.75 8.48 9.75 15.02"></polygon></svg>
              </a>
              <a href="https://www.instagram.com/meridian_excellence/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full flex items-center justify-center transition-all text-primary hover:bg-primary/5 hover:-translate-y-1">
                <Instagram size={24} />
              </a>
              <a href="https://www.facebook.com/share/1B8Kd5DDDz/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full flex items-center justify-center transition-all text-primary hover:bg-primary/5 hover:-translate-y-1">
                <Facebook size={24} />
              </a>
              <Link to="/contact" className="w-12 h-12 rounded-full flex items-center justify-center transition-all text-primary hover:bg-primary/5 hover:-translate-y-1">
